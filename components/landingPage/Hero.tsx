  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex flex-col items-center justify-center">
      ...
      <div className="absolute inset-0 flex items-center justify-center z-0">
        {rings.map((ring, index) => (
          <div key={index} className={`
                absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full border border-purple-300/20 shadow-[0_0_150px_inset] shadow-purple-200/10
              `}
            style={{
              width: `${ring.width}px`,
      ...
      <div className="z-10 text-center px-4">
        <h1 className="text-5xl md:7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-purple-200">
          PDF Analysis Tool
        </h1>
